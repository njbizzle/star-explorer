...
-- Load the background
local background = display.newImageRect( backGroup, "images/background.png", "images", 800, 1400 )
...
-- Add an event listener that reponds to tap and fires the laser
...
-- Add an event listener that reponds to touch and moves the ship
